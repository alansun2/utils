...
import com.tj.model.util.AliSMSParams;
import lombok.extern.slf4j.Slf4j;

/**
 * @author alan
 * @createtime 18-8-10 下午1:17 * 阿里短信服务工具类
 */
@Slf4j
public class AliSMSUtil {
    ...
    //替换成你的AK
    private static String accessKeyId = null;//你的accessKeyId,参考本文档步骤2
    private static String accessKeySecret = null;//你的accessKeySecret，参考本文档步骤2
     ...
     */
    private static IAcsClient getAcsClient(AliSMSParams params) throws ClientException {
        if (null == acsClient) {
     ...
     * @throws ClientException e
     */
    public static boolean send(AliSMSParams params) throws ClientException {
        params.valid();
        ...
        //初始化ascClient,暂时不支持多region（请勿修改）
        IAcsClient acsClient = getAcsClient(params);
