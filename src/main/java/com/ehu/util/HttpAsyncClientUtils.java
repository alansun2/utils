...
//                builder.loadTrustMaterial(SSlUtil.getKeyStore("/opt/appdata/ssl/server.keystore", "123456"), new TrustSelfSignedStrategy());
//                SSLConnectionSocketFactory sslsf = new SSLConnectionSocketFactory(builder.build());
                ...
                // 初始化连接管理器
                poolConnManager = new PoolingNHttpClientConnectionManager(ioReactor, null, sessionStrategyRegistry, null);
     ...
     * @throws IOException
     */
    public static void doAsyncGet(HttpParams httpParams) throws IOException {
        // 创建http GET请求
